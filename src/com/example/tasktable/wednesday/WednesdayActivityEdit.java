...
public class WednesdayActivityEdit extends Activity {
	...
	public void onBackPressed() {
		...
		c = 1;
		try {
			WednesdaySQL mySQL = new WednesdaySQL(WednesdayActivityEdit.this);
			mySQL.Open();
		...
		Intent i = new Intent(WednesdayActivityEdit.this, Wednesday.class);
		startActivity(i);
		super.onBackPressed();
	}
	...
	protected void onStop() {
		...
		if (c == 0) {
			...
			try {
				WednesdaySQL mySQL = new WednesdaySQL(
						WednesdayActivityEdit.this);
				mySQL.Open();
				if ((getText != null) && (!getText.isEmpty())) {
