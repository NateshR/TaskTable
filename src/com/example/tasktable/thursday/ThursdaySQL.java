...
public class ThursdaySQL {

	public static final String key_id = "note_id";
	public static final String note = "note";

	public static final String Database_name = "database_note_thursday";
	public static final String Database_table = "database_table_thursday";
	...
	// DATABASEOVER
	public ThursdaySQL(Context c) {
		ourContext = c;
	}

	public ThursdaySQL Open() throws SQLException {
