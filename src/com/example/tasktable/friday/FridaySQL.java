...
public class FridaySQL {

	public static final String key_id = "note_id";
	public static final String note = "note";

	public static final String Database_name = "database_note_friday";
	public static final String Database_table = "database_table_friday";
	...
	// DATABASEOVER
	public FridaySQL(Context c) {
		ourContext = c;
	}
	
	public FridaySQL Open() throws SQLException {
