...
public class SundayActivityEdit extends Activity {
	...
	public void onBackPressed() {
		...
		c = 1;
		try {
			SundaySQL mySQL = new SundaySQL(SundayActivityEdit.this);
			mySQL.Open();
		...
		Intent i = new Intent(SundayActivityEdit.this, Sunday.class);
		startActivity(i);
		super.onBackPressed();
	}
