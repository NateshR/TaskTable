package com.example.tasktable.sunday;
...
public class SundaySQL {

	public static final String key_id = "note_id";
	public static final String note = "note";

	public static final String Database_name = "database_note_sunday";
	public static final String Database_table = "database_table_sunday";
	...
	// DATABASEOVER
	public SundaySQL(Context c) {
		ourContext = c;
	}

	public SundaySQL Open() throws SQLException {
