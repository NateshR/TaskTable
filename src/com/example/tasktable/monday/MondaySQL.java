...
public class MondaySQL {

	public static final String key_id = "note_id";
	public static final String note = "note";

	public static final String Database_name = "database_note_monday";
	public static final String Database_table = "database_table_monday";
	...
	// DATABASEOVER
	public MondaySQL(Context c) {
		ourContext = c;
	}

	public MondaySQL Open() throws SQLException {
