...
public class MondayActivityEdit extends Activity {
	...
	public void onBackPressed() {
		...
		c = 1;
		try {
			MondaySQL mySQL = new MondaySQL(MondayActivityEdit.this);
			mySQL.Open();
		...
		Intent i = new Intent(MondayActivityEdit.this, Monday.class);
		startActivity(i);
		super.onBackPressed();
	}
