...
public class SaturdayActivityEdit extends Activity {
	...
	public void onBackPressed() {
		...
		c = 1;
		try {
			SaturdaySQL mySQL = new SaturdaySQL(SaturdayActivityEdit.this);
			mySQL.Open();
		...
		Intent i = new Intent(SaturdayActivityEdit.this, Saturday.class);
		startActivity(i);
		super.onBackPressed();
	}
