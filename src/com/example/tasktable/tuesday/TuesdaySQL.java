...
public class TuesdaySQL {

	public static final String key_id = "note_id";
	public static final String note = "note";

	public static final String Database_name = "database_note_tuesday";
	public static final String Database_table = "database_table_tuesday";
	...
	// DATABASEOVER
	public TuesdaySQL(Context c) {
		ourContext = c;
	}

	public TuesdaySQL Open() throws SQLException {
