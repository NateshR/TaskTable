...
public class TuesdayActivityEdit extends Activity {
	...
	public void onBackPressed() {
		...
		try {
			TuesdaySQL mySQL = new TuesdaySQL(TuesdayActivityEdit.this);
			mySQL.Open();
		...
		Intent i = new Intent(TuesdayActivityEdit.this, Tuesday.class);
		startActivity(i);
		super.onBackPressed();
	}
